...
# ax.fill_betweenx([cota_inferior, cota_superior], 0, 360, color='gray', alpha=0.3, label='Región de Factibilidad')
...
# plt.text(0.2, 0.6, additional_info, transform=plt.gca().transAxes, fontsize=11,
#          bbox=dict(facecolor='white', alpha=0.7))
# plt.savefig('desempeno_modelos2.pdf', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.text(0.15, 0.65, additional_info, transform=plt.gca().transAxes, fontsize=11,
         bbox=dict(facecolor='white', alpha=0.7))

# Guardar la gráfica en un archivo de alta calidad
plt.savefig('comparacion_modelos2.pdf', bbox_inches='tight')
